...
;//
;// This routine should be generated ONE time and then manually maintained!
;//
;;*****************************************************************************
;;
...
namespace <NAMESPACE>
    ...
    subroutine PopulateReplicationKey
        ...
        ;;Include the structure for each record type that needs REPLICATION_KEY populateing on STORE
